...
possible_operators = [
    ...
    {'name': 'Rx', 'obj': RXGate(np.pi), 'img_path': '../../static/img/Rx.gif'},
    {'name': 'Ry', 'obj': RYGate(np.pi), 'img_path': '../../static/img/Ry.gif'},
    {'name': 'Rz', 'obj': RZGate(np.pi), 'img_path': '../../static/img/Rz.gif'},
